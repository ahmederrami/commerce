    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watchedBy', models.ManyToManyField(blank=True, related_name='watchedListings', to=settings.AUTH_USER_MODEL)),
                ('winner', models.ForeignKey(blank=True, default='test', on_delete=django.db.models.deletion.CASCADE, related_name='wonListings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bidBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userBids', to=settings.AUTH_USER_MODEL)),
